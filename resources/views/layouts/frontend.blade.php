...
<head>
  ...
  <title>Index - Empower Your Church with a Smarter Management System</title>
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">Church Flock System</h1>
        <span>.</span>
      </a>
...
<footer id="footer" class="footer dark-background">
    ...
    <div class="row gy-4">
      <div class="col-lg-4 col-md-6 footer-about">
        <a href="index.html" class="logo d-flex align-items-center">
          <span class="sitename">Church Flock System</span>
        </a>
      ...
      <div class="col-lg-2 col-md-3 footer-links">
        <h4>Our Services</h4>
        <ul>
          <li><a href="#">Member & Group Management</a></li>
          <li><a href="#">Event Management</a></li>
          <li><a href="#">Announcements</a></li>
          <li><a href="#">Donations Tracking</a></li>
  ...
  <div class="container copyright text-center mt-4">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://supertechnomads.com/">Supertech Nomads</a>
    </div>
  </div>
