            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="{{ route('ministries.index') }}" class="btn btn-sm btn-primary btn-round ml-auto">
                ...
                <div class="card-body">
                    ...
                    <form id="ministries-create"
                        action="@if(isset($ministry->id))  
                            {{ route('ministries.update', ['ministry' => $ministry->id]) }}
                            @else {{ route('ministries.store' ) }} @endif"
                        method="post"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Full Name" name="name" value="{{ old('name', $ministry->name ?? '') }}" required />
